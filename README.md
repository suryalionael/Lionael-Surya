...
| 💰 [Beyond GDP](case-studies/beyond-gdp/) | Case Study | Does GDP per capita actually predict national happiness, once health, employment, connectivity, and inflation are controlled for — R regression, diagnostics, and robustness testing | ✅ Shipped |
...
flowchart LR
    ...
    subgraph DE[Data Engineering]
        B1[Ingestion]
        B2[Orchestration<br/>Airflow]
        B3[Data Lake / Warehouse]
    end

    subgraph AE[Analytics Engineering]
        C1[dbt Models<br/>Staging → Marts]
        C2[Tests & Docs]
    end

    subgraph ML[Machine Learning / AI]
    ...
    subgraph CLOUD[Cloud & DevOps — underpins everything]
        F1[Docker]
        F2[CI/CD]
        F3[AWS]
    end
...
gantt
    dateFormat  YYYY-MM
    axisFormat  %b %Y
    title Portfolio Build Roadmap

    section Foundations
    SQL + Python fundamentals        :done, f1, 2026-06, 1M
    ...
    section Capstone
    End-to-End Retail Data Platform  :cap1, after a1, 2M

    section Applications
    Internship Applications Open     :crit, app1, 2026-09, 6M
```
